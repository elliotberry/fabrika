...
export default class Text extends FabricObject {
  constructor(props, context) {
    ...
    this.renderf = (ctx) => this.state.object && this.state.object.render(ctx);
    this.toObject = (propertiesToInclude) =>
      this.state.object && this.state.object.toObject(propertiesToInclude);
    this.toSVG = (reviver) =>
      this.state.object && this.state.object.toSVG(reviver);
    this.complexity = () => 1;
  }
...
Text.fromElement = (element, options) =>
  fabric.Text.fromElement(element, options);
...
Text.defaultProps = Object.assign(FabricObject.defaultProps, {
  type: "text",
  stateProperties: FabricObject.defaultProps.stateProperties.concat([
    "fontFamily",
    "fontWeight",
    "fontSize",
    "text",
