...
export default class IText extends Text {
  constructor(props, context) {
    ...
    this.isEmptyStyles = () =>
      this.state.object && this.state.object.isEmptyStyles();
    this.setSelectionStart = (index) =>
      this.state.object && this.state.object.setSelectionStart(index);
    this.setSelectionEnd = (index) =>
      this.state.object && this.state.object.setSelectionEnd(index);
    this.getSelectionStyles = () =>
      this.state.object && this.state.object.getSelectionStyles();
    this.setSelectionStyles = (styles) =>
      this.state.object && this.state.object.setSelectionStyles(styles);
    this.renderCursorOrSelection = () =>
      this.state.object && this.state.object.renderCursorOrSelection();
    this.get2DCursorLocation = (selectionStart) =>
      this.state.object &&
      this.state.object.get2DCursorLocation(selectionStart);
    this.getCurrentCharStyle = (lineIndex, charIndex) =>
      this.state.object &&
    ...
    this.getCurrentCharColor = (lineIndex, charIndex) =>
      this.state.object &&
      this.state.object.getCurrentCharColor(lineIndex, charIndex);
    this.renderCursor = (boundaries, ctx) =>
      this.state.object && this.state.object.renderCursor(boundaries, ctx);
